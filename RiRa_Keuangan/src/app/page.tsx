...
import { 
  LayoutDashboard, Database, Wallet, TrendingDown, TrendingUp, DollarSign, 
  Package, Store, ShoppingBag, Calendar, User, LogOut 
} from 'lucide-react'
      ...
      <header className="bg-slate-900 text-white px-6 py-4 shadow-md z-20 print:hidden border-b border-slate-800">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold tracking-tight text-white leading-tight">Dashboard RiRa</h1>
          ...
          <div className="flex flex-wrap items-center justify-center gap-2">
            <Link href="/master" className="flex items-center gap-2 px-3 py-2 rounded-lg border border-yellow-400/40 text-yellow-400 hover:bg-yellow-400/10 transition-colors text-xs font-bold uppercase tracking-wider active:scale-95">
              <Database className="w-4 h-4" /> Data
            </Link>
            <Link href="/transaksi" className="flex items-center gap-2 px-3 py-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white transition-colors shadow-lg shadow-blue-600/20 text-xs font-bold uppercase tracking-wider active:scale-95">
              <Wallet className="w-4 h-4" /> Jual
            </Link>
            <Link href="/pengeluaran" className="flex items-center gap-2 px-3 py-2 rounded-lg bg-red-600 hover:bg-red-700 text-white transition-colors shadow-lg shadow-red-600/20 text-xs font-bold uppercase tracking-wider active:scale-95">
              <TrendingDown className="w-4 h-4" /> Keluar
            </Link>
            
            <form action={signOut}>
              <button className="flex items-center gap-2 px-3 py-2 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white transition-colors border border-slate-700 ml-2 active:scale-95" title="Sign Out">
